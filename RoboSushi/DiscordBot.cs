...
public class DiscordBot
{
    ...
    private async void PresenceTimer_Tick(object? stateInfo)
    {
        switch (this._presenceState)
        {
            ...
            default:
                await this._client.SetStatusAsync(UserStatus.Online);
                await this._client.SetGameAsync(" with yout mother", null, ActivityType.Playing);
                break;
        }
    ...
    {
        Console.WriteLine($"{DateTime.Now:dd.MM.yyyy HH:mm:ss} | {message.Severity.ToString().PadRight(8)[..8]} | {message.Source.PadRight(8)[..8]} | {message.Message ?? message.Exception.Message}");
    ...
    public async Task SendOffNotification(string username, DateTime ended, string streamUrl, string iconUrl)
    {
        ...
        {
            Author = new() { Name = username, Url = $"https://www.twitch.tv/{username}/about", IconUrl = iconUrl },
            Description = $"**[{EscapeMessage(username)}](https://www.twitch.tv/{username})** is *offline* right now.\nBut you can watch the latest [VODs](https://www.twitch.tv/{username}/videos).",
            ImageUrl = streamUrl,
            Timestamp = ended,
    ...
    public async Task SendDiscordStreamNotification(DiscordEmbedBuilder embed, String? everyone = null)
    {
        ...
        ulong messageId = (ulong)ConfigManager.Db.notify_message_id;
        ...
        ConfigManager.Db.notify_message_id = message.Id;
        AppDb.WriteFile();
    }

    public static async Task SendBanNotification(string channelName, string channelIcon, string bannerName, string bannerIcon, string userName, string userIcon, DateTime userCreated, string? reason = null)
    {
        DiscordEmbedBuilder embed = new()
        {
    ...
    public static async Task SendUnbanNotification(string channelName, string channelIcon, string bannerName, string bannerIcon, string userName, string userIcon, DateTime userCreated)
    {
        DiscordEmbedBuilder embed = new()
        {
            Author = new() { Name = bannerName, IconUrl = bannerIcon },
    ...
    public static async Task SendTimeoutNotification(string channelName, string channelIcon, string bannerName, string bannerIcon, string userName, string userIcon, DateTime userCreated, TimeSpan duration, string? reason = null)
    {
        DiscordEmbedBuilder embed = new()
        {
            Author = new() { Name = bannerName, IconUrl = bannerIcon },
    ...
    public static async Task SendUntimeoutNotification(string channelName, string channelIcon, string bannerName, string bannerIcon, string userName, string userIcon, DateTime userCreated)
    {
        DiscordEmbedBuilder embed = new()
        {
            Author = new() { Name = bannerName, IconUrl = bannerIcon },
    ...
    public static async Task SendMessageDeletedNotification(string channelName, string channelIcon, string deleterName, string deleterIcon, string userName, string userIcon, DateTime userCreated, string message)
    {
        DiscordEmbedBuilder embed = new()
        {
    ...
    public static async Task SendChatClearedNotification(string channelName, string channelIcon, string clearerName, string clearerIcon)
    {
        DiscordEmbedBuilder embed = new()
        {
    ...
    public static async Task SendSubscriberOnlyNotification(string channelName, string channelIcon, string modName, string modIcon, bool on)
    {
        DiscordEmbedBuilder embed = new()
        {
    ...
    public static async Task SendEmoteOnlyNotification(string channelName, string channelIcon, string modName, string modIcon, bool on)
    {
        DiscordEmbedBuilder embed = new()
        {
            Author = new() { Name = modName, IconUrl = modIcon },
    ...
    public static async Task SendR9kBetaNotification(string channelName, string channelIcon, string modName, string modIcon, bool on)
    {
        DiscordEmbedBuilder embed = new()
        {
            Author = new() { Name = modName, IconUrl = modIcon },
